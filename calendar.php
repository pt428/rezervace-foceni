                          ...
                          if(isset($filteredReservations)) {
                                foreach ($filteredReservations as $reservation  ) {                              
                                    if($actualTimeRange === $reservation["time_range"]){
                                        ...
                                        // Vytvoření dvou datových objektů
                                             $date1 =  new DateTime(); // Vytvoří aktuální datum a čas 
               ...
               <?php
                    ...
                    if($blockingTime!="") {                    
                                   ...
                                   echo 'startCountdown(targetDate'.$timerNumber.', "timer'.$timerNumber.'"); </script>';
                                    ...
                                    // echo "<button class='btn btn-info w-100'>Někdo rezervuje <span id='timer".$timerNumber .'></span></button>';
                                  
                                ?>

               <button class='btn btn-info w-100'>Někdo rezervuje <span
                       id="timer<?php echo $timerNumber?>"></span></button>
               <?php $blockingTime="";
                        }else{
